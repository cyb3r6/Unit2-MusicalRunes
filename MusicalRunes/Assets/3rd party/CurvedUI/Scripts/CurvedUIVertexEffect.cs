...
namespace CurvedUI
{
    ...
    public partial class CurvedUIVertexEffect : BaseMeshEffect
    {
        ...
        UIVertex CurveVertex(UIVertex input, float cylinder_angle, float radius, Vector2 canvasSize)
        {
            ...
            // addition: get the graphic local position
            GraphicPositionLocalPosition = input.position;
        ...
        /// <summary>
        /// Addition, expose the graphic position in local space
        /// </summary>
        public Vector3 GraphicPositionLocalPosition
        {
            get;
            set;
        }
